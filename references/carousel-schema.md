...
- `cover_visual_mode`: `generative` o `technical`.
- `brand`: profilo risolto conforme a [brand-profile.md](brand-profile.md).
...
- `title_serif`, `title_accent`, `summary_serif`, `summary_accent`: massimo due frasi esatte presenti nel testo associato.
...
Il manifest finale deve contenere testo pulito e campi serif espliciti. Non lasciare asterischi nei campi testuali.
