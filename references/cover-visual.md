...
Generare una sola immagine verticale per la copertina dopo l'approvazione di profilo e testi e prima della prova visuale. Derivare soggetto, scena e metafora dalla fonte corrente; derivare stile, tecnica, palette e tono da `brand.visual_direction` e dagli altri campi del profilo. Per impostazione predefinita non generare disegni, SVG o illustrazioni decorative per le slide interne.
...
- Preferire un'immagine 4:5 di almeno 1440×1800. Se lo strumento produce un rapporto diverso, dichiararlo e mantenere soggetti ed elementi essenziali dentro una safe area compatibile con il crop 4:5.
- Salvare il file accanto al manifest o in `assets/`, mai nella cartella finale che il renderer ricrea.
- Dopo il rendering, correggere prima `cover_image_position`; rigenerare l'immagine solo se il problema è compositivo.
...
Se la sessione non può generare immagini, mostrare nella prova metafora, composizione, palette e ingombri del visuale come layout dichiarato. Non presentare una descrizione o un segnaposto come immagine prodotta.
