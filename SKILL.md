...
12. Se è selezionato `local-editor`, creare il manifest in stato `bozza`, avviare l'editor secondo [references/visual-review.md](references/visual-review.md) e aprirlo nel browser. Mostrare nell'editor le varianti di logo realmente disponibili e i comandi contestuali per grassetto, corsivo, sottolineatura, evidenziatore e commento. Non limitarsi a stampare il codice HTML nella chat e non duplicare l'intera anteprima, salvo richiesta dell'utente o fallback.
